...
def main(args):
    ...
    # Setup wandb
    wandb.init(mode='disabled',project=f"QM9-{args.target_name}")
    ...
    for _ in tqdm(range(args.epochs)):
        ...
        if epoch_mae_val < best_val_mae:
            ...
            torch.save(checkpoint, str(pwd)+"/Models/"+"IMPSN_PH_"+str(args.target_name)+  ".pth")
            test_mae = 0
            ...
            test_mae = float(test_mae/len(test_loader.dataset))
...
if __name__ == "__main__":
    ...
    print("Property trained is",parsed_args.target_name)
